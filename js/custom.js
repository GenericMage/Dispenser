...
console.log("URI copied to clipboard:", this.provider.connector.uri);
...
// Fallback for no wallet or not on Polygon
this.wpolCost = "0 WPOL"; // Static display
console.log("No signer or not on Polygon, setting static cost");
